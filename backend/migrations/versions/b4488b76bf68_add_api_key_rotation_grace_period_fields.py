...
def upgrade() -> None:
    op.add_column('projects', sa.Column('previous_api_key_hash', sa.String(length=255), nullable=True))
    op.add_column('projects', sa.Column('key_rotated_at', sa.DateTime(timezone=True), nullable=True))
